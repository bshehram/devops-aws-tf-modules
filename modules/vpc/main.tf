...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "${var.optional_prefix}igw"
  }
}

# resource "aws_cloudwatch_log_group" "vpcflow" {
#   name              = "${var.optional_prefix}vpcflow"
...
#   name   = "${var.optional_prefix}vpcflow_policy"
...
resource "aws_default_security_group" "main" {
  ...
  tags = {
    Name = "${var.optional_prefix}default"
  }
}
